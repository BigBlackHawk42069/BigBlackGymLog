...
(function() {
    ...
    const CSS_STYLES = `
            ...
            /*====================================================================================================================================*/
                    ...
                    .bbgl-bestgym-lead { border-bottom:1px solid rgba(255,255,255,.06); box-shadow:none; } /*-------------------------*/
                    .bbgl-subgroup-row { position:relative; padding-left:24px; } /*----------------------------------------------------*/
                    .bbgl-subgroup-row::before { content:''; position:absolute; left:10px; top:0; bottom:0; width:2px; background:#555; }
                    .bbgl-subgroup-row:not(.bbgl-subgroup-row-last) { border-bottom:none; box-shadow:none; } /*-----------------------*/
                    .bbgl-subgroup-row:not(.bbgl-subgroup-row-last)::after { content:''; position:absolute; left:10px; right:0; bottom:0;
